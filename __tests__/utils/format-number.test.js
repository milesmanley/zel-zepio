...
describe('formatNumber', () => {
  test('should append ZEL in balance amount', () => {
    const myBalance = formatNumber({ value: 2.5, append: 'ZEL ' });

    const expectedState = 'ZEL 2.5';

    expect(myBalance).toEqual(expectedState);
  });

  test('should multiply ZEL balance and show it in USD', () => {
  ...
  test('should multiply decimal ZEL balance and show it in USD', () => {
    const myBalanceInUsd = formatNumber({
