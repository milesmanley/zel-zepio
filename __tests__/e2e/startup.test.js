...
describe('Startup', () => {
  ...
  test('should show the text "Zel-Zepio Starting" in loading screen', async () => {
    expect(
  ...
  test('should show the zel logo in loading screen', () => expect(
    app.client.getAttribute('div[data-testid~="LoadingScreen"]:first-child img', 'src'),
  ).resolves.toEqual(expect.stringContaining('/assets/zel-simple-icon.svg')));
