...
export type APIMethods = {
  ...
  verifymessage: (zelcashaddress: string, signature: string, message: string) => Promise<boolean>,
  z_validateaddress: (
    zaddr: string,
  ) => Promise<{
    isvalid: boolean,
  ...
  getaccount: (zelcashaddress: string) => Promise<string>,
  ...
  getreceivedbyaddress: (zelcashaddress: string, minconf?: number) => Promise<number>,
  gettransaction: (
    txid: string,
  ...
  importprivkey: (zelprivkey: string, label?: string, rescan?: boolean) => Promise<void>,
  ...
  setaccount: (zelcashaddress: string, account: string) => Promise<void>,
