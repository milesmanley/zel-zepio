...
import zepioLogo from '../assets/images/zel-icon.png';
        ...
        {electron.remote.process.env.NODE_ENV !== 'test' && (
          ...
          >
            {() => (
              <ModalContent>
                <ContentWrapper>
                  <LogoComponent src={zepioLogo} alt='Zel-Zepio' />
                  <TitleComponent value='Hello from Zel-Zepio' isBold />
                  <WelcomeText value='Zel-Zepio is a cross-platform full-node Zel wallet that allows users to easily send and receive ZEL. With first-class support for Sapling shielded addresses, users are able to create truly private transactions using a modern and intuitive interface.' />
                  <WelcomeText value='Zel-Zepio aims to improve the user experience for those seeking true financial privacy online.' />
                  <AdditionalText value='Zel-Zepio will need to sync the Zel blockchain data before using all features.' />
                </ContentWrapper>
              </ModalContent>
            )}
          </ConfirmDialogComponent>
