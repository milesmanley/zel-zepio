...
import { ZEL_EXPLORER_BASE_URL } from '../constants/explorer';
    ...
    <Wrapper>
      ...
      <DetailsWrapper>
        ...
        <TextComponent
          value={formatNumber({
            ...
            value: new BigNumber(amount).times(zelPrice).toNumber(),
          })}
          size={1.5}
      ...
      <InfoRow>
        <ColumnComponent width='100%'>
          ...
          <TransactionId onClick={() => openExternal(ZEL_EXPLORER_BASE_URL + transactionId)}>
