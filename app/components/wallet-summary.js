    ...
    <OutsideWrapper>
      ...
      <Wrapper>
        <TotalContainer>
          ...
          />
          <USDValue
            value={`USD $${formatNumber({ value: total * zelPrice })}`}
        ...
        <DetailContainer>
          ...
          <MiddleLabel
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: shielded * zelPrice })}`} />
        </DetailContainer>
        <DetailContainer>
          ...
          <MiddleLabel
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: transparent * zelPrice })}`} />
        </DetailContainer>
        <DetailContainer>
          ...
          <UnconfirmedValue
            ...
            size='16px'
          />
          <USDValue value={`USD $${formatNumber({ value: unconfirmed * zelPrice })}`} />
        </DetailContainer>
      </Wrapper>
    </OutsideWrapper>
  );
