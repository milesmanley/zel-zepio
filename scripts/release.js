...
const OWNER = 'zeltechnologies';
const PROJECT = 'zel-zepio';
...
const getFileName = (name) => {
  ...
  switch (extension) {
    case 'dmg':
      return `Zel-Zepio-macOS-v${VERSION}.dmg`;
    case 'deb':
      return `zel-zepio-linux-v${VERSION}.deb`;
    case 'exe':
      return `Zel-Zepio-Windows-v${VERSION}.exe`;
    case 'zip':
